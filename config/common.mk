...
ifdef CM_BUILDTYPE
    ...
    CM_EXTRAVERSION := _RELEASE_2.8.9
endif
...
ifeq ($(CM_BUILDTYPE), RELEASE)
    ...
    ifeq ($(PRODUCT_VERSION_MINOR),0)
        CM_VERSION := $(PRODUCT_VERSION_MAJOR)-REMIX-$(shell date -u +%Y%m%d)-$(CM_BUILD)-$(CM_BUILDTYPE)$(CM_EXTRAVERSION)
    else
        CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-REMIX-$(shell date -u +%Y%m%d)-$(CM_BUILD)-$(CM_BUILDTYPE)$(CM_EXTRAVERSION)
    endif
endif
